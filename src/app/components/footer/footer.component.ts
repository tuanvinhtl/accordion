...
@Component({
  selector: "app-footer",
  template: ` <footer class="absolute top-0 left-0 w-full h-10 flex justify-between px-4 md:px-10 items-center">
    <a href="https://sreyaj.dev" class="flex space-x-1 font-semibold">
      <svg
        width="20"
        height="20"
        viewBox="0 0 54 54"
      ...
      >
        ...
        >
          ...
          />
          <path
            d="M43.6995 29.5493H22.275L33.0649 3.0015L43.6995 29.5493Z"
            fill="white"
          />
        </mask>
        <g mask="url(#mask0)">
      ...
      <p class="text-sm">sreyaj.dev</p>
    </a>
    <a href="https://twitter.com/Adisreyaj" class="flex space-x-1 items-center">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
        width="24"
